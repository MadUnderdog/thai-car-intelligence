...
export async function GET(request: Request) {
  ...
  try {
    ...
    if (q) {
      whereClause += ` AND (v."nameEn" ILIKE $${paramIdx++} OR v."nameTh" ILIKE $${paramIdx++} OR cm."nameEn" ILIKE $${paramIdx++} OR cm."nameTh" ILIKE $${paramIdx++} OR m."nameEn" ILIKE $${paramIdx++} OR m."nameTh" ILIKE $${paramIdx++})`;
      const like = `%${q}%`;
