/**
 * Batch #3 research price discovery ingestion — new sources.
 */

import { PrismaPg } from "@prisma/adapter-pg";
import { PrismaClient } from "@prisma/client";
import pg from "pg";
import { BATCH3_OBSERVATIONS } from "../lib/catalog/batch3-research";

async function main() {
  console.log("Starting batch3 research price discovery ingestion...");
  ...
  for (const obs of BATCH3_OBSERVATIONS) {
