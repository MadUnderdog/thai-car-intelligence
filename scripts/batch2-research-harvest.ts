/**
 * Research price discovery ingestion — handles batch2-research observations.
 */

import { PrismaPg } from "@prisma/adapter-pg";
import { PrismaClient } from "@prisma/client";
import pg from "pg";
import { BATCH2_OBSERVATIONS, type ResearchPriceObservation } from "../lib/catalog/batch2-research";

async function main() {
  console.log("Starting batch2 research price discovery ingestion...");
  ...
  for (const obs of BATCH2_OBSERVATIONS) {
